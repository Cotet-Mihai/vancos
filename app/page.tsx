...
export default function Home() {
  return (
    <>
      <section className="relative isolate flex h-screen min-h-[640px] flex-col items-center justify-center overflow-hidden bg-ink px-6 text-center">
        <Image
          src={heroImage}
      ...
      <div className="relative z-10 mx-auto -mt-16 grid max-w-5xl gap-6 px-6 sm:-mt-20 sm:grid-cols-3">
        <div className="flex flex-col gap-3 rounded-[2rem] bg-white p-6 shadow-xl">
